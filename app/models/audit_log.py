...
class AuditAction:
    ...
    JUGGLING_BALL_DETECTION_QUERIED   = "JUGGLING_BALL_DETECTION_QUERIED"
    JUGGLING_BALL_DETECTION_CREATED   = "JUGGLING_BALL_DETECTION_CREATED"
    # AN-3B2F: Global Ball Training Hub — consent lifecycle audit (PR-1A)
    JUGGLING_TRAINING_CONSENT_REVOKED = "JUGGLING_TRAINING_CONSENT_REVOKED"

    # MC1: MultiCamera session/cycle orchestration
    MC_SESSION_CREATED          = "MC_SESSION_CREATED"
    MC_SESSION_JOINED           = "MC_SESSION_JOINED"
    MC_SESSION_ACTIVATED        = "MC_SESSION_ACTIVATED"
    MC_SESSION_QUERIED          = "MC_SESSION_QUERIED"
    MC_DEVICE_REGISTERED        = "MC_DEVICE_REGISTERED"
    MC_DEVICE_STATUS_UPDATED    = "MC_DEVICE_STATUS_UPDATED"
    MC_DEVICE_HEARTBEAT         = "MC_DEVICE_HEARTBEAT"
    MC_CYCLE_CREATED            = "MC_CYCLE_CREATED"
    MC_CYCLE_SCHEDULED          = "MC_CYCLE_SCHEDULED"
    MC_CYCLE_STOPPED            = "MC_CYCLE_STOPPED"
    MC_CYCLE_CONFIRM_START      = "MC_CYCLE_CONFIRM_START"
    MC_CYCLE_CONFIRM_STOP       = "MC_CYCLE_CONFIRM_STOP"
    MC_CYCLE_QUERIED            = "MC_CYCLE_QUERIED"
    MC_SYSTEM_TIME_QUERIED      = "MC_SYSTEM_TIME_QUERIED"
